...
//        tabBarCurveShapeLayer.strokeColor = UIColor.white.cgColor
        tabBarCurveShapeLayer.fillColor = UIColor().hexStringToUIColor(hex: "#F5F7F9").cgColor
        tabBarCurveShapeLayer.strokeColor =  UIColor().hexStringToUIColor(hex: "#F5F7F9").cgColor
