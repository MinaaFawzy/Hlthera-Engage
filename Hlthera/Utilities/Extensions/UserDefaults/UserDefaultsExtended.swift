...
extension UserDefaults {
    ...
    func isPractoEnabled() -> Bool {
        return self.bool(forKey: kIsPractoEnabled)
    }
    
    func setPractoEnabled(isPractoEnabled: Bool) {
        self.set(isPractoEnabled, forKey: kIsPractoEnabled)
        self.synchronize()
    }
    ...
    func setNotificationsEnable(status: Bool)
    {
        self.set(status, forKey:"notificationsEnable")
        self.synchronize()
    }
    
    func getNotificationsEnable() -> Bool
    {
        return self.bool(forKey: "notificationsEnable")
    }
