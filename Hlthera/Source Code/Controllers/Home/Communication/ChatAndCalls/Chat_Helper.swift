...
//    func SendMessage(dic:Dictionary<String, Any> ,Senderid :String , Receiverid:String,bookingId:String) {
//        var  node = Senderid < Receiverid ? "\(String.getString(Senderid))_\(String.getString(Receiverid))" :  "\(String.getString(Receiverid))_\(String.getString(Senderid))"
//
//        node = node + "_\(bookingId)"
...
//            self.sendChatMessageAPI(friend_id: Receiverid, message: String.getString(messageData[Parameters.content]), chat_id: node, message_id: autoKey, bookingId: bookingId)
//        }
//    }
//    
//    
...
//    func Receivce_message(Senderid :String , Receiverid:String,bookingId:String , message:@escaping (_ result: [MessageClass]? , _ chatBackup : [ChatbackupOnetoOne]?, _ success: Bool, _ isExist: Bool) -> ()) -> Void {
...
//                    MessageList.saveMessages(result: msgs, userId: Receiverid, bookingId: bookingId)
//                }
////                else {
////
...
//    func ResentUser(lastmessage:String, Receiverid:String , Senderid :String  , name:String , profile_image:String , readState :String, isMsgSend: Bool, lastTimestamp: String, msgReceiverId: String, unreadCount: Int, friendStatus: Bool, callStatus: String = "0") {
//
...
//                    Parameters.profile_image: String.getString(userDetails[kProfilePicture]),
//                    Parameters.lastmessage : String.getString(lastmessage),
//                    Parameters.timeStamp : String.getString(lastTimestamp) ,
//                    Parameters.readState : String.getString(readState),
//                    Parameters.senderid : String.getString(Senderid),
...
//                }
//
//                if vc .isKind(of: ConversationListViewController.self) {
...
//    func deleteMessage(Senderid :String , Receiverid:String, bookingId: String , uid:String) {
//
...
//
//        var node = Senderid < Receiverid ? "\(String.getString(Senderid))_\(String.getString(Receiverid))" :  "\(String.getString(Receiverid))_\(String.getString(Senderid))"
//        node = node + "_\(String.getString(bookingId))"
//        if node == Parameters.emptyString {
//            return
//        }
//        var isDeleted = String()
//        Database.database().reference().child(Parameters.Message).child(Parameters.PrivateMessages).child(node).child(uid).child(Parameters.isDeleted).observe(.value) { (snapshot) in
//            if snapshot.exists() {
...
//        callDetails[Parameters.senderid] = kSharedUserDefaults.getLoggedInUserId()
...
//                    
//                    if key != kSharedUserDefaults.getLoggedInUserId() {
//                        members.append(key)
//                    }
//                    
//                }
...
//        let loggedInUserid = kSharedUserDefaults.getLoggedInUserId()
//        typingReferense.child(loggedInUserid).child(receiverid).setValue(status)
//    }
//    
//    func getTypingStat(receiverid: String, status:@escaping (_ result: Int?) -> ()) -> Void {
//        let loggedInUserid = kSharedUserDefaults.getLoggedInUserId()
//        
//        typingReferense.child(receiverid).child(loggedInUserid).observe(.value)  { (snapshot) in
//            
//            if snapshot.exists() {
...
//    }
//    //send notification
//    fileprivate func sendChatMessageAPI(friend_id: String, message: String, chat_id: String, message_id: String,bookingId:String = "") {
//
