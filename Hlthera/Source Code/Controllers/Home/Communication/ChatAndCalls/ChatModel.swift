...
//
//    class func saveMessages(result:Dictionary<String, Any>, userId: String, bookingId:String) {
//
//        let userDetails = kSharedUserDefaults.getLoggedInUserDetails()
//        let loggedInUserid = String.getString(userDetails[Parameters.user_id])
//
...
//        var chatId = loggedInUserid < senderid ? "\(String.getString(loggedInUserid))_\(String.getString(senderid))" : "\(String.getString(senderid))_\(String.getString(loggedInUserid))"
//        chatId = chatId + "_\(bookingId)"
...
//        var tempArr = [Dictionary<String, Any>]()
//
//        let messages = MessageList.fetchMessagesForUser(userid: userId, bookingId: String.getString("")) ?? []
...
//    }
//
//    class func fetchMessagesForUser(userid: String,bookingId:String) -> [MessageClass]? {
//
//        let userDetails = kSharedUserDefaults.getLoggedInUserDetails()
//        let loggedInUserid = String.getString(userDetails[Parameters.user_id])
//        var chatId = loggedInUserid < userid ? "\(String.getString(loggedInUserid))_\(String.getString(userid))" : "\(String.getString(userid))_\(String.getString(loggedInUserid))"
//        chatId = chatId + "_\(bookingId)"
